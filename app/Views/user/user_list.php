														...
														<div class="mb-10">
															...
															<div class="d-flex flex-column flex-wrap fw-bold" data-kt-customer-table-filter="payment_type">
																...
																<label class="form-check form-check-sm form-check-custom form-check-solid mb-3 me-5">
																	...
																	<span class="form-check-label text-gray-600">Discharged</span>
																</label>
																<!--end::Option-->
																<!--begin::Option-->
																<label class="form-check form-check-sm form-check-custom form-check-solid mb-3">
																	<input class="form-check-input" type="radio"/>
																	<span class="form-check-label text-gray-600">Admitted</span>
																</label>
																<!--end::Option-->
															</div>
															<!--end::Options-->
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
											...
											<thead>
												...
												<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
													...
													<th class="min-w-125px">Adress</th>
											...
											<tbody class="fw-bold text-gray-600">
												<tr>
													...
													<!--begin::Name=-->
													<td>
														<a href="../../demo1/dist/apps/customers/view.html" class="text-gray-800 text-hover-primary mb-1"><?= esc($usuario['nombre']) ?></a>
													</td>
													<!--end::Name=-->
													<!--begin::Email=-->
													<td>
														<a href="#" class="text-gray-600 text-hover-primary mb-1"><?= esc($usuario['email']) ?></a>
													</td>
													<!--end::Email=-->
													<!--begin::Company=-->
