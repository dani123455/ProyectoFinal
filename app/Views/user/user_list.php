												...
												<div class="card-header border-0 pt-6 justify-content-end">
													...
													<div class="card-toolbar">
														...
														<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
															...
															<!--end::Filter-->
															<!--begin::Export-->
															<a href="<?=base_url('usuarios/export')?>">
													...
													<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
														...
														<?php foreach ($usuarios as $usuario): ?>
															<tr>
																...
																<!--end::Name=-->
																<!--begin::Email=-->
																<td style="<?= is_null($usuario['fecha_baja']) ? '' : 'color: red;' ?>"><?= esc($usuario['email']) ?></td>
																<!--end::Email=-->
																<!--begin::Company=-->
																<td style="<?= is_null($usuario['fecha_baja']) ? '' : 'color: red;' ?>"><?= esc($usuario['rol_nombre']) ?></td>
																<!--end::Company=-->
																<!--begin::Payment method=-->
																<td style="<?= is_null($usuario['fecha_baja']) ? '' : 'color: red;' ?>"><?= esc($usuario['telefono']) ?></td>
																<!--end::Payment method=-->
																<!--begin::Date=-->
