...
<html lang="en">
	...
	<head><base href="ProyectoFinal">
		...
		<!-- Swapy CSS -->
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swapy@1.0.0/dist/swapy.min.css">
    ...
    <path d="M5 16C4.45 16 4 16.45 4 17C4 17.55 4.45 18 5 18C5.55 18 6 17.55 6 17C6 16.45 5.55 16 5 16ZM19 16C18.45 16 18 16.45 18 17C18 17.55 18.45 18 19 18C19.55 18 20 17.55 20 17C20 16.45 19.55 16 19 16ZM5 14H19C20.1 14 21 14.9 21 16V17C21 18.1 20.1 19 19 19H5C3.9 19 3 18.1 3 17V16C3 14.9 3.9 14 5 14ZM5 10H19C20.1 10 21 10.9 21 12V14H3V12C3 10.9 3.9 10 5 10ZM5 6H19C20.1 6 21 6.9 21 8V10H3V8C3 6.9 3.9 6 5 6Z" fill="black"/>
					...
					<div class="content d-flex flex-column flex-column-fluid " id="kt_content">
						...
						<div class="toolbar top-0" id="kt_toolbar">
							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                                ...
                                <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class=" fw-bold page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                                    <h4>Welcome, <?= session()->get('nombre') ?>!</h4>
                                </div>
								<!--end::Page title-->
								<!--begin::Actions-->
								<!--end::Actions-->
						...
						<div class="post d-flex flex-column-fluid" id="kt_post">
							...
							<div id="kt_content_container" class="container-xxl">
								<!--begin::Row-->
								<div class="row gy-5 g-xl-8 container">
									<!--begin::Col-->
									<div class="col-xxl-4" data-swapy-slot="a">
									...
									<!--end::Col-->
									<!--begin::Col-->
									<div class="col-xxl-4" data-swapy-slot="b">
										<!--begin::List Widget 5-->
									...
									<!--end::Col-->
									<!--begin::Col-->
									<div class="col-xxl-4" data-swapy-slot="c">
										<!--begin::Mixed Widget 7-->
										<div class="card card-xxl-stretch-50 mb-5 mb-xl-8" data-swapy-item="c">
											<!--begin::Body-->
								...
								<div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
									<!-- Card 1: Line Chart -->
									<div class="col" data-swapy-slot="a" style="width:700px;">
										<div class="card shadow-sm">
											<div class="card-body">
												<h5 class="card-title">Sale</h5>
												<div data-swapy-item="a" id="line-chart"></div>
											</div>
										</div>
									</div>

									<!-- Card 2: Bar Chart -->
									<div class="col" data-swapy-slot="b" style="width:500px;">
										<div class="card shadow-sm">
											<div class="card-body">
												<h5 class="card-title">Employees</h5>
												<div data-swapy-item="b" id="bar-chart"></div>
											</div>
										</div>
									</div>

									<!-- Card 3: Pie Chart -->
									<div style="width:700px;" data-swapy-slot="c" class="col">
										<div class="card shadow-sm">
											<div class="card-body">
												<h5 class="card-title">Cars</h5>
												<div data-swapy-item="c" id="pie-chart"></div>
											</div>
										</div>
									</div>

									<!-- Card 4: Area Chart -->
									<div class="col" data-swapy-slot="d" style="width:500px;">
										<div class="card shadow-sm">
											<div class="card-body">
												<h5 class="card-title">Earnings</h5>
												<div data-swapy-item="d" id="area-chart"></div>
											</div>
										</div>
									</div>
								</div>
		...
		<!-- Swapy JS -->
<script src="https://cdn.jsdelivr.net/npm/swapy@1.0.0/dist/swapy.min.js"></script>
  ...
  var options2 = {
    ...
    xaxis: { categories: ['January', 'February', 'March', 'May', 'June'] }
  };
  ...
  var options3 = {
    ...
    series: [45, 25, 15, 15],
    labels: ['Audi', 'Mercedes', 'Opel', 'Citroen']
  };
  ...
  chart4.render();
    ...
    document.addEventListener("DOMContentLoaded", function () {
        new Swapy({
            selector: '[data-swapy-slot]', // Define los elementos a intercambiar
            speed: 400, // Duración de la transición en milisegundos
            autoSwap: true // Configura si el cambio debe suceder automáticamente
        });
    });
</script>
