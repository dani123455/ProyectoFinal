							...
							<div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
								...
								<div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
									...
									<ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
										...
										<!--end::Item-->
										<!--begin::Item-->
										<li class="breadcrumb-item text-dark">Brand Listing</li>
										<!--end::Item-->
									</ul>
									<!--end::Breadcrumb-->
								</div>
									...
									<div class="card-header border-0 pt-6">
										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<form method="GET" action="<?=base_url('marcas')?>">
													<input type="text" name="nombre" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Brand" value="<?= isset($name) ? $name : '' ?>" />
												</form>
										...
										<div class="card-toolbar">
											...
											<div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
												...
												<!--begin::Add customer-->
												<?php if (session()->get('rol_id') == 1): ?>
													<button type="button" class="btn btn-primary"><a class="menu-link text-white" href="<?= base_url('marcas/save')?>">Add Brand</a></button>
												<?php endif?>
												<!--end::Add customer-->
											</div>
										</div>
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
											...
											<thead>
												...
												<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
													<th class="min-w-125px"><a href="<?= base_url('marcas?sort=nombre&order=' . ($sort == 'nombre' && $order == 'asc' ? 'desc' : 'asc')) ?>">Brand</a></th>
													<?php if (session()->get('rol_id') == 1): ?>
