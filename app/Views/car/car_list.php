										...
										<div class="card-title">
											...
											<div class="d-flex align-items-center position-relative my-1">
												...
												<form method="GET" action="<?=base_url('coches')?>">
													<input type="text" name="marca_nombre" data-kt-customer-table-filter="search" class="form-control form-control-solid w-250px ps-15" placeholder="Search Brand" value="<?= isset($marca_nombre) ? $marca_nombre : '' ?>" />
												</form>
										...
										<table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
											...
											<thead>
												...
												<tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
													<th class="min-w-125px"><a href="<?=base_url('coches?sort=marca_nombre&order=' . ($sort == 'marca_nombre' && $order == 'asc' ? 'desc' : 'asc'))?>"></a>Brand</a></th>
													<th class="min-w-125px"><a href="<?=base_url('coches?sort=modelo&order=' . ($sort == 'modelo' && $order == 'asc' ? 'desc' : 'asc'))?>">Model</a></th>
													<th class="min-w-125px"><a href="<?=base_url('coches?sort=año&order=' . ($sort == 'año' && $order == 'asc' ? 'desc' : 'asc'))?>">Year</a></th>
													<th class="min-w-125px"><a href="<?=base_url('coches?sort=precio&order=' . ($sort == 'precio' && $order == 'asc' ? 'desc' : 'asc'))?>">Price</a></th>
													<th class="min-w-125px"><a href="<?=base_url('coches?sort=disponible&order=' . ($sort == 'disponible' && $order == 'asc' ? 'desc' : 'asc'))?>">Available</a></th>
													<?php if (session()->get('rol_id') == 1): ?>
